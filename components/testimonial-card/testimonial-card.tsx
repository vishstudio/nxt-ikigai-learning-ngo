...
const TestimonialCard: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="bg-white p-10 md:p-12 rounded-[2rem] shadow-sm transition-all duration-500 border border-ikigai-dark/5 group hover:cursor-pointer hover:shadow-md">
        ...
        <p className="text-xl md:text-2xl font-serif text-ikigai-dark leading-relaxed mb-10 transition-all duration-500 ease-out">
          &quot;{quote}&quot;
        </p>
