    ...
    <section className="py-32 bg-ikigai-bg relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <Button href={(siteData as any).phone.href} className="py-5 px-10 text-sm">
            Volunteer With Us
          </Button>

          <Button href={`mailto:${(siteData as any).email}`} variant="outlined" className="py-5 px-10 text-sm">
            Make a Donation
          </Button>
        </div>
      </motion.div>
